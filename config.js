var config = {
    ...
    accessToken: 'pk.eyJ1IjoiamltZGFsZXkiLCJhIjoiY21oeHIzanN1MDRjZzJqcHYzOTI2ZHhnMiJ9.92tczXH-1swPAun1FrlfGw',
    showMarkers: false,
    markerColor: '#3FB1CE',
    theme: 'light',
    use3dTerrain: false,
    ...
    chapters: [
        ...
        },
        {
        ...
        }, 
         {
            ...
            description: 'Agents deployed at least 1 tear gas canister outside Humboldt Park Health — a hospital — after protesters surrounded Border Patrol vehicles.', 
            location: {
